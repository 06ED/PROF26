...
class _SignupPageState extends State<SignupPage> {
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        hint: "********",
                        validator: _processPasswordConfirmValidation,
  ...
  String? _processPasswordConfirmValidation(String? text) =>
      text != null &&
  ...
  Future<void> _processSignup() async {
    if (_formKey.currentState?.validate() ?? false) {
      await _useCase.signup(
        ...
        onResponse: (_) async => _useCase.login(
  ...
  void _getToLogin() => Get.off(LoginPage());
}
